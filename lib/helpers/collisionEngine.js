class CollisionEngine {
  ...
  bombDeploymentCollision() {
    ...
    this.movingObject.speed = this.movingObject.map.gameSpeed
  ...
  bomb(direction){
    return function(bomb){
      //This function will have access to both bomb and direction
      //Make this function such that I can pass in any direction
      //Feel free to make your first pass verbose and full of if statements, but aim for an elegant solution
    }
  }

  collision(direction){
    return function(block){
      //This function will have access to both block and direction
      //Make this function such that I can pass in any direction
      //Feel free to make your first pass verbose and full of if statements, but aim for an elegant solution
    }
  }
  ...
  //Now that bomb is defined, you can do this:
  this.bombLeft = bomb("left");
  //which replaces the bombLeft definition above, but still allows you to call this.bombLeft in the same way

  //Then continue to apply these concepts until you have a couple elegant functions that return the other functions you use here.
